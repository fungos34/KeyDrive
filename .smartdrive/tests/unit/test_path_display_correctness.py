...
# test file is at .smartdrive/tests/unit/test_path_display_correctness.py
_test_file = Path(__file__).resolve()
_unit_dir = _test_file.parent
_tests_root = _unit_dir.parent
_smartdrive_root = _tests_root.parent  # This is .smartdrive/
...
class TestPathDisplayCorrectness:
    ...
    def test_recovery_dir_name_is_just_folder_name(self):
        ...
        spec = importlib.util.spec_from_file_location("recovery_module", _smartdrive_root / "scripts" / "recovery.py")

        # Read the file and extract RECOVERY_DIR_NAME
        recovery_py = _smartdrive_root / "scripts" / "recovery.py"
