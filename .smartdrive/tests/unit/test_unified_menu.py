...
# Setup path - test file is at .smartdrive/tests/unit/test_unified_menu.py
# .smartdrive is tests/unit/../../ = .smartdrive
_test_file = Path(__file__).resolve()
_smartdrive_root = _test_file.parent.parent.parent  # tests/unit -> tests -> .smartdrive
