...
# Import constants
try:
    from variables import PRODUCT_NAME, PRODUCT_DESCRIPTION
except ImportError:
...
# CLI i18n support
try:
    from cli_i18n import init_cli_i18n, tr as cli_tr, get_cli_lang, set_cli_lang
    _HAS_CLI_I18N = True
except ImportError:
    _HAS_CLI_I18N = False
...
def print_unified_menu(admin_status: bool, style: "ConsoleStyle" = None):
    ...
    if CLIOperations is not None and hasattr(CLIOperations, 'MENU_SECTIONS'):
        ...
        menu_sections = [
            ("Operations", ["mount", "unmount", "setup", "rekey", "keyfile_utils", 
                           "config_status", "recovery", "sign_scripts", "verify_integrity",
                           "challenge_hash", "update", "help"])
        ]
...
def main_menu_unified():
    ...
    if CLIOperations is not None and hasattr(CLIOperations, 'MENU_SECTIONS'):
        ...
        menu_order = ["mount", "unmount", "setup", "rekey", "keyfile_utils",
                      "config_status", "recovery", "sign_scripts", "verify_integrity",
                      "challenge_hash", "update", "help"]
