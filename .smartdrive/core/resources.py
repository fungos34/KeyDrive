...
def get_icon_candidates(
    filename: str, launcher_root: Optional[Path] = None, include_png_fallback: bool = True
) -> List[Path]:
    """
...
def resolve_icon_path(
    filename: str, launcher_root: Optional[Path] = None, log_resolution: bool = True
) -> Optional[Path]:
    """
...
def get_app_icon_path(launcher_root: Optional[Path] = None, prefer_ico: bool = True) -> Optional[Path]:
    """
...
def get_logo_main_ico(theme: Optional[str] = None, launcher_root: Optional[Path] = None) -> Optional[Path]:
    """
...
def get_logo_main_png(theme: Optional[str] = None, launcher_root: Optional[Path] = None) -> Optional[Path]:
    """
...
def get_logo_for_platform(
    theme: Optional[str] = None, launcher_root: Optional[Path] = None, prefer_ico: bool = True
) -> Optional[Path]:
    """
