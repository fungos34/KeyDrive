...
class Limits:
    ...
    # Diskpart device readiness retries (Windows)
    DISKPART_DEVICE_READY_MAX_RETRIES = 3
    ...
    # Diskpart device readiness retry delay (Windows)
    DISKPART_DEVICE_READY_RETRY_DELAY_SECONDS = 2
