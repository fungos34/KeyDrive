#!/usr/bin/env python3
"""
DEV-ONLY WRAPPER: Forwards to .smartdrive/scripts/mount.py

This wrapper allows running `python scripts/mount.py` from the repo root during development.
