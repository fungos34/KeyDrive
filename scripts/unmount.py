#!/usr/bin/env python3
"""
DEV-ONLY WRAPPER: Forwards to .smartdrive/scripts/unmount.py

This wrapper allows running `python scripts/unmount.py` from the repo root during development.
