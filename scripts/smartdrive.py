#!/usr/bin/env python3
"""
DEV-ONLY WRAPPER: Forwards to .smartdrive/scripts/smartdrive.py

This wrapper allows running `python scripts/smartdrive.py` from the repo root during development.
